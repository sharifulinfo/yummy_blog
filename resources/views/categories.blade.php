...
<div class="breadcumb-area" style="background-image: url({{url('')}}/{{$cat_name->category_img}});">
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$cat_name->category_name}}<?php 
                            $value = DB::table('blogs')->where('blog_category',$cat_name->id)->count();
